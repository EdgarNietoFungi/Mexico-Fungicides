...
macrophomina.data <-
  read.csv("data/tebuconazole.macrophomina.csv")
...
write.csv(macrophomina.xx, file = "outputs/tebuconazole.macrophomina.EC50.csv")
write.csv(summary.macrophomina.xx, file = "outputs/tebuconazole.macrophomina.summary. EC50.csv")
...
ggsave("tebuconazole.macrophomina.xx.png")
