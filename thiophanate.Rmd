...
write.csv(macrophomina.xx, file = "outputs/thiophanate.methyl.macrophomina.EC50.csv") 
write.csv(summary.macrophomina.xx, file = "outputs/thiophanate.methyl.macrophomina.summary. EC50.csv") 
...
ggsave("thiophanate.methyl.macrophomina.xx.png")
...
write.csv(sclerotium.yy, file = "outputs/thiophanate.methyl.sclerotium.EC50.csv") 
write.csv(summary.sclerotium.yy, file = "outputs/thiophanate.methyl.sclerotium.summary. EC50.csv")
...
ggsave("thiophanate.methyl.sclerotium.yy.png")
```
